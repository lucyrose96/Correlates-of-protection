These files are for the manuscript "A statistical method for evaluating vaccine-induced immune correlates of protection against infection and disease progression: application to the ChAdOx1-S nCoV-19 phase 3 trial".

The R scripts for the analysis of the University of Oxford/AstraZeneca sponsored trial, COV002 are provided in the COV002 folder:
